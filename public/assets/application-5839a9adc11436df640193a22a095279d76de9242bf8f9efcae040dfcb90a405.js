    ...
    Plugin.prototype = {
        ...
        _isVisible: function(item) {
            var docViewTop      = $window.scrollTop() + item.options.offset,
                ...
                elemBottom      = elemTop + item.element.height()/2
            ;
...
(function(window, document, undefined) {
	...
	*/
	...
	function validaCPF(){
		...
		if (TestaCPF(strCPF) ){
			document.getElementById('user_cpf').style.backgroundColor="transparent"; // "input-cadastro col-xs-1 col-sm-2 col-md-2 col-lg-2"
		} else{
