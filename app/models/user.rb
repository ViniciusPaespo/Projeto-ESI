class User < ActiveRecord::Base
	...
	validates_presence_of :password_digest, message: "deve ser preenchido"
	validates_length_of :password_digest, maximum: 10, message: "Sua senha deve ser menor de 10 digítos"
	validates_length_of :password_digest, minimum: 6 , message: "Sua senha deve conter pelo menos 6 digítos"
